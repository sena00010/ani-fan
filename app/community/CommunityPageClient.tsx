...
import {
    ...
    setFollowOrUnFollow,
} from "@/store/slices/communityUserSlice";
import {
    getProfile,
    selectUserProfile,
...
export default function CommunityPageClient({
    ...
    const { communityPostLikeData } = useSelector(
        (state: RootState) => state.communityPost
    );

    const userProfileData = useSelector(selectUserProfile) as UserProfile;
